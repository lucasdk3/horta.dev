...
const resources = {
  ...
  es: {
    translation: {
      ...
      "about.mission.p1": "Horta nació de una observación crítica: la industria a menudo carece de datos precisos, accesibles e imparciales sobre las prácticas de ingeniería en el mundo real. Aunque existen muchos informes, con frecuencia pasan por alto los matices regionales y los flujos de trabajo específicos.",
      "about.mission.p2": "Nuestro objetivo es plantar las semillas de um futuro más transparente. Queremos entender los patrones, las ferramentas e as metodologias mundiais. Ao regar esse conocimiento global, capacitamos indivíduos e organizações a crescerem juntos.",
